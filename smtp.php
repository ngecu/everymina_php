<?php
$to = 'devngecu@gmail.com';
$subject = 'EverMina Tests';
$message = 'Hi devngecu'; 
$from = 'ngecu16@gmail.com';
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
	      ...
	      <tr>
          <td valign="middle" class="hero bg_white" style="background-image: url(https://everymina.com//uploads/posts/sauti-sol-og_image.webp); background-size: cover; height: 400px;">
		      	...
		      	<table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
						  <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
						  	...
						  	<td valign="middle" width="30%" style="text-align:center; padding-right: 2.5em;">
						  		...
						  		<span><a href="#" class="btn btn-primary">Read</a></span>
						  	</td>
						  </tr>
						  <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
						  	<td valign="middle" width="70%" style="text-align:left; padding: 0 2.5em;">
