...
<!--<br>-->
<!--    <center><h1 style="color:yellow">About Us !</h1><center>-->
<!--    <h3 style="text-align: center;">Welcome To <span id="W_Name1">www.everymina.com</span></h3>-->
<!--  <center>-->
<!--  <p style="color:white;font-size:40px;">-->
<!--  Everymina is a website that ensures you<br> receive all of the information you require  <br>-->
<!--  every minute, cutting across all spheres <br>of life and assisting you in becoming more <br>-->
<!--  informed, improving your well-being, and <br>becoming a better person on a daily basis. <br>-->
...
<!--<span style="color: green; font-size: 16px; font-weight: bold; text-align: center;">Have a nice day !</span></p>-->
<!--</body>  -->
